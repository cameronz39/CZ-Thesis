###########################################################################
## Makefile generated for component 'motorPositionTest'. 
## 
## Makefile     : motorPositionTest.mk
## Generated on : Fri Dec 20 19:14:19 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/motorPositionTest.elf
...
PRODUCT_NAME              = motorPositionTest
MAKEFILE                  = motorPositionTest.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2024b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2024b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/camer/OneDrive/Desktop/CZ-THE~1/SIMULI~1/MY_DRI~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH                 = C:/Users/camer/DOCUME~1/MATLAB/R2024b/ARDUIN~1/ARDUIN~1/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/motorPositionTest.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/target/supportpackages/arduinobase/include -I$(START_DIR)/include -I$(START_DIR)/libraries -IC:/ProgramData/MATLAB/SupportPackages/R2024b/aCLI/data/packages/arduino/hardware/avr/1.8.3/libraries/SPI/src -IC:/ProgramData/MATLAB/SupportPackages/R2024b/aCLI/data/packages/arduino/hardware/avr/1.8.3/libraries/Wire/src -IC:/ProgramData/MATLAB/SupportPackages/R2024b/aCLI/data/packages/arduino/hardware/avr/1.8.3/libraries/Wire/src/utility -I$(START_DIR)/motorPositionTest_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/common -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/default -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(ARDUINO_AVR_ROOT)/hardware/avr/$(AVR_LIB_VERSION)/cores/arduino -I$(ARDUINO_AVR_ROOT)/hardware/avr/$(AVR_LIB_VERSION)/variants/mega -IC:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/target/supportpackages/arduinotarget/include -IC:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/target/supportpackages/arduinotarget/scheduler/include -I$(ARDUINO_AVR_ROOT)/tools/avr-gcc/$(AVR_GCC_LIB_VERSION)/avr/include
...
DEFINES_STANDARD = -DMODEL=motorPositionTest -DNUMST=3 -DNCSTATES=3 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_ArduinoEncoder.o ShieldWrapper.o ShieldArduino.o SPI.o Wire.o twi.o xcp_ext_mode.o motorPositionTest.o motorPositionTest_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o platform_timer.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/motorPositionTest_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/motorPositionTest_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/motorPositionTest_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MW_ArduinoEncoder.o : C:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/target/supportpackages/arduinobase/src/MW_ArduinoEncoder.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


ShieldWrapper.o : $(START_DIR)/src/ShieldWrapper.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


ShieldArduino.o : $(START_DIR)/libraries/ShieldArduino.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


SPI.o : C:/ProgramData/MATLAB/SupportPackages/R2024b/aCLI/data/packages/arduino/hardware/avr/1.8.3/libraries/SPI/src/SPI.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


Wire.o : C:/ProgramData/MATLAB/SupportPackages/R2024b/aCLI/data/packages/arduino/hardware/avr/1.8.3/libraries/Wire/src/Wire.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


twi.o : C:/ProgramData/MATLAB/SupportPackages/R2024b/aCLI/data/packages/arduino/hardware/avr/1.8.3/libraries/Wire/src/utility/twi.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/motorPositionTest_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


motorPositionTest.o : $(START_DIR)/motorPositionTest_ert_rtw/motorPositionTest.c
	$(CC) $(CFLAGS) -o "$@" "$<"


motorPositionTest_data.o : $(START_DIR)/motorPositionTest_ert_rtw/motorPositionTest_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
